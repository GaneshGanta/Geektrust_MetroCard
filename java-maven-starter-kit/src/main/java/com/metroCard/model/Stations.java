...
public class Stations {
	...
	public Stations(String stationName, Integer totalCollection, Integer totalDiscount, Integer adultCount,
	...
	public String toString() {
		return "Stations [stationName=" + stationName + ", totalCollection=" + totalCollection + ", totalDiscount="
				+ totalDiscount + ", adultCount=" + adultCount + ", seniorCount=" + seniorCount + ", kidCount="
				+ kidCount + "]";
	}
